...
const base = [_][]const Uop{
    ...
    &[_]Uop{ .fetch_word_flush, .nz, .add_cc_call, .ex_pc, .call_suffix, .adl_imm }, // call nz,nn
    ...
    &[_]Uop{ .add_cc_1, .set_00h, .ex_pc, .call_suffix, .adl_inst }, // rst 00h
    ...
    &[_]Uop{ .fetch_word_flush, .z, .add_cc_call, .ex_pc, .call_suffix, .adl_imm }, // call z,nn
    &[_]Uop{ .fetch_word_flush, .ex_pc, .call_suffix, .adl_imm }, // call nn
    &[_]Uop{ .fetch_byte, .save, .load_a, .adc_bytes, .store_a }, // adc a,n
    &[_]Uop{ .add_cc_1, .set_08h, .ex_pc, .call_suffix, .adl_inst }, // rst 08h
    ...
    &[_]Uop{ .fetch_word_flush, .nc, .add_cc_call, .ex_pc, .call_suffix, .adl_imm }, // call nc,nn
    ...
    &[_]Uop{ .add_cc_1, .set_10h, .ex_pc, .call_suffix, .adl_inst }, // rst 10h
    ...
    &[_]Uop{ .fetch_word_flush, .c, .add_cc_call, .ex_pc, .call_suffix, .adl_imm }, // call c,nn
    &[_]Uop{ .add_r_1, .fetch_byte, .dispatch_dd }, // DD
    &[_]Uop{ .fetch_byte, .save, .load_a, .sbc_bytes, .store_a }, // sbc a,n
    &[_]Uop{ .add_cc_1, .set_18h, .ex_pc, .call_suffix, .adl_inst }, // rst 18h
    ...
    &[_]Uop{ .fetch_word_flush, .po, .add_cc_call, .ex_pc, .call_suffix, .adl_imm }, // call po,nn
    ...
    &[_]Uop{ .add_cc_1, .set_20h, .ex_pc, .call_suffix, .adl_inst }, // rst 20h
    ...
    &[_]Uop{ .fetch_word_flush, .pe, .add_cc_call, .ex_pc, .call_suffix, .adl_imm }, // call pe,nn
    &[_]Uop{ .add_r_1, .fetch_byte, .dispatch_ed }, // ED
    &[_]Uop{ .fetch_byte, .save, .load_a, .xor_bytes, .store_a }, // xor a,n
    &[_]Uop{ .add_cc_1, .set_28h, .ex_pc, .call_suffix, .adl_inst }, // rst 28h
    ...
    &[_]Uop{.clear_ief}, // di
    &[_]Uop{ .fetch_word_flush, .p, .add_cc_call, .ex_pc, .call_suffix, .adl_imm }, // call p,nn
    ...
    &[_]Uop{ .add_cc_1, .set_30h, .ex_pc, .call_suffix, .adl_inst }, // rst 30h
    ...
    &[_]Uop{ .fetch_word_flush, .m, .add_cc_call, .ex_pc, .call_suffix, .adl_imm }, // call m,nn
    &[_]Uop{ .add_r_1, .fetch_byte, .dispatch_fd }, // FD
    &[_]Uop{ .fetch_byte, .save, .load_a, .sub_bytes }, // cp a,n
    &[_]Uop{ .add_cc_1, .set_38h, .ex_pc, .call_suffix, .adl_inst }, // rst 38h
};
